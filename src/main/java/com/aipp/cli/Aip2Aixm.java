...
/**
 * AIP to AIXM converter executable
 * Converts aeronautical information publications to AIXM format
 */
public class Aip2Aixm {
    
    private static final Logger logger = LogManager.getLogger(Aip2Aixm.class);
    ...
    public static void main(String[] args) {
        try {
            ...
            logger.info("Converting AIP for region: {}", region);
    ...
    private static void showHelp() {
        System.out.println("Usage: aip2aixm [options]");
        System.out.println();
